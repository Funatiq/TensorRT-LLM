...
class PoolRestoreMode(enum.Enum):
    NONE = 0
    MEMSET = 1
    CPU = 2
    PINNED = 3

class PoolSleepToken: ...
class PoolWakeToken: ...
...
class KVCacheManager:
    ...
    def supports_pool_sleep(self) -> bool: ...
    def prepare_pool_sleep(self, mode: PoolRestoreMode, stream: int) -> PoolSleepToken: ...
    def commit_pool_sleep(self, token: PoolSleepToken) -> None: ...
    def abort_pool_sleep(self, token: PoolSleepToken) -> None: ...
    def prepare_pool_wakeup(self, stream: int) -> PoolWakeToken: ...
    def commit_pool_wakeup(self, token: PoolWakeToken, stream: int) -> None: ...
    def abort_pool_wakeup(self, token: PoolWakeToken) -> None: ...
